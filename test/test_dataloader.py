...
class LRW1000_Dataset(Dataset):
    ...
    #     self.anno = '/home/zhaosheng/Documents/lip-reading-model/LRW1000_Public/info/all_audio_video.txt'
...
if(__name__ == '__main__'):
    ...
    pic_dir = f'/home/zhaosheng/Documents/lip-reading-model/test/output_pics/'
    infos = [
        ["gfb","国防部","guo fang bu",0.38,1.7]
    ]
